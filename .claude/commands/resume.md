...
Buscar archivos en `~/.claude/projects/-Users-victor-PycharmProjects-ataraxiadive/memory/`:
...
- Consultar CLAUDE.md para entender qué debería venir después en la cadena IEDD
