...
| **Definición de Terminado:**                                                                                                                                                                                                                                                                                             |
|                                                                                                                                                                                                                                                                                                                          |
| El torneo tiene las 5 disciplinas iniciales (STA, DNF, DBF, DYN, SPE2X50). El organizador asigna un juez a cada disciplina (RF-US-04). El juez solo ve y opera las disciplinas asignadas. Se ejecutan múltiples disciplinas secuencialmente. Los atletas que no registraron anuncio no aparecen en la grilla (RF-PR-04). |
+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
