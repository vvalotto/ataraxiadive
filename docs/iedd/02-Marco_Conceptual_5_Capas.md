...
El desarrollo de soluciones digitales puede entenderse como una cadena
...
Cada capa transforma conocimiento del dominio en algo cada vez más
ejecutable.

La inteligencia artificial puede intervenir principalmente en las capas
inferiores,

sin reemplazar las superiores.
...
El objetivo en esta capa es comprender el problema y el contexto.

No existe todavía ninguna decisión tecnológica.
...
La arquitectura define cómo organizar el sistema para implementar la
especificación.
...
La arquitectura conecta el modelo conceptual con la implementación
técnica.
...
Con la aparición de la IA, parte de esta capa puede generarse
automáticamente a partir de la especificación.
...
Este marco permite reinterpretar la ingeniería de software como la
disciplina que

transforma conocimiento de un dominio en sistemas ejecutables mediante
modelos y especificaciones precisas.

Los lenguajes de programación pasan a ser tecnologías de implementación,

no el núcleo de la disciplina.
