...
Al completar el registro, la plataforma te inicia sesión automáticamente con el primer rol seleccionado y te lleva a tu portal.

Si seleccionaste múltiples roles, es posible que debas elegir con cuál querés entrar — ver [Iniciar sesión](iniciar-sesion.md).
