...
software_items:
  - src/competencia/application/commands/corregir_resultado.py
test_units:
...
| RF | Descripción |
|----|-------------|
| [[RF-EJ-06-correccion-resultado-registrado]] | Corrección con ventana de impugnación (INV-P-15, HS-P2 ✅) |
