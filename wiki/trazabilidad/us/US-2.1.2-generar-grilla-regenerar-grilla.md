...
tests_count: null
rf:
  - RF-PR-04-atleta-sin-ap-no-compite
...
| RF | Descripción |
|----|-------------|
| [[RF-PR-04-atleta-sin-ap-no-compite]] | Atleta sin AP no compite — no aparece en grilla (P-05) |
| [[RF-PR-05-orden-salida-por-ap]] | Orden de grilla: AP ascendente (DNF/DYN/DBF/STA) o descendente (SPE) |
