...
tests_count: null
rf:
  - RF-PM-06-publicacion-resultados-descargables
software_items:
...
Expone el ranking overall del torneo vía endpoint REST, permitiendo consultar el ranking general calculado por [[US-3.5.1-aggregate-rankingoverall-calcularoverallhandler]] y disparado por [[US-3.5.2-politica-p-09-overall-automatico-al-cerrar-torneo]].

## RFs cubiertos

| RF | Descripción |
|----|-------------|
| [[RF-PM-06-publicacion-resultados-descargables]] | Publicación en plataforma + descarga |
