...
Conecta la política P-10 ([[US-4.5.3-politica-p-10-email-al-atleta-al-confirmar-inscripcion]]) al flujo real de inscripción: enriquece el evento `InscripcionConfirmada` con los datos del atleta y lo publica desde el composition root.
