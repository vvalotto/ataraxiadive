...
Tab `Jueces` del panel organizador. Permite asignar un juez a cada disciplina del torneo mediante un selector. La precondición de grilla para habilitar el selector fue refinada en [[US-5.1.9-precondicion-de-grilla-para-asignacion-de-juez]].
