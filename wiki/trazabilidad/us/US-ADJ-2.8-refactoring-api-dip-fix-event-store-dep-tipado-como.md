...
- Complementa [[US-ADJ-1.4-refactoring-api-dip-en-router-p-08-a-composition-root-refactoring-api-dip-en-router-p-08-a-composition-root]] que inició el DIP en el router
